...
os.environ[
    "VALIDATION_MANAGER_LAMBDA_ARN"
] = "arn:aws:lambda:ap-southeast-2:602836945884:function:agha-gdr-validation-pipeline-validation-manager"
os.environ[
    "NOTIFICATION_LAMBDA_ARN"
] = "arn:aws:lambda:ap-southeast-2:602836945884:function:agha-gdr-validation-pipeline-notification"
os.environ["FOLDER_LOCK_LAMBDA_ARN"] = "FOLDER_LOCK_LAMBDA_ARN"
...
os.environ["AUTORUN_VALIDATION_JOBS"] = "no"
