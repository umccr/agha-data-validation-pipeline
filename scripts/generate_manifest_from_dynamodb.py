...
def generate_manifest_from_dydb():
    ...
    for flagship in flagship_list:
        ...
        for submission in submission_date_list:
            ...
            manifest_item = dynamodb.get_batch_item_from_pk_and_sk(DYNAMODB_STORE_TABLE, dynamodb.FileRecordPartitionKey.MANIFEST_FILE_RECORD.value, submission)
            ...
            s3.upload_s3_object_local_file(bucket_name=STORE_BUCKET_NAME, local_file=manifest_filename,
