...
os.environ["RESULTS_BUCKET"] = 'agha-results-dev'
os.environ["STORE_BUCKET"] = 'agha-store-dev'
os.environ["S3_JOB_DEFINITION_ARN"] = 'arn:aws:batch:ap-southeast-2:843407916570:job-definition/agha-gdr-s3-manipulation:10'
