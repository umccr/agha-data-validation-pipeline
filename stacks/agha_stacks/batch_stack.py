...
class BatchStack(core.NestedStack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        vpc = ec2.Vpc.from_lookup(self, "MainVPC", vpc_id=batch_environment["vpc_id"])
        ...
        instance_types_2_vcpu = ["m4.large", "m5.large"]

        compute_environment_spec_list = [
            {
                "type": "small",
                "queue_name": batch_environment["batch_queue_name"]["small"],
                "compute_environment_name": batch_environment[
        ...
        self.batch_security_group = ec2.SecurityGroup(
            ...
            vpc=vpc,
            description="Defined outbound only traffic for AGHA validation pipeline batch instsance",
        ...
        for compute_environment_spec in compute_environment_spec_list:
            ...
            batch_compute_environment = batch.ComputeEnvironment(
                ...
                compute_environment_name=compute_environment_spec[
                    "compute_environment_name"
                ],
                compute_resources=batch.ComputeResources(
                    ...
                    instance_types=[
                        ec2.InstanceType(it)
                        for it in compute_environment_spec["instance_type"]
                    ],
        ...
        self.batch_job_definition = batch.JobDefinition(
            self,
            "BatchJobDefinition",
            job_definition_name=batch_environment[
                "file_validation_job_definition_name"
            ],
            container=batch.JobDefinitionContainer(
                image=ecs.ContainerImage.from_ecr_repository(
                    repository=ecr.Repository.from_repository_name(
                        ...
                        repository_name=batch_environment["file_validation_ecr"][
                            "name"
                        ],
                    ),
